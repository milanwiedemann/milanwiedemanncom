...
During the course of my PhD I started to feel the superpowers of [R](https://cran.r-project.org/) `r emo::ji("rocket")` and have created some tools that make my life a bit easier, see [here](/software).
