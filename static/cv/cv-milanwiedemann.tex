...
\item Evaluating clinical outcomes and patient experiences in the Trust
\item Developing open source tools to access and analyse healthcare data in R and SQL
\end{rSubsection}
