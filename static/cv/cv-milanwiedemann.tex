...
% for apa6
\usepackage[style = apa, backend = biber, language = american, url=true, doi=true]{biblatex}
...
\begin{rEmptySubsection}{Preparing for Learning and Teaching at Oxford}{January 2018}{University of Oxford, Medical Sciences Division, 1 day}{} 
\end{rEmptySubsection}
